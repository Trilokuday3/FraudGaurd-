...
either side — dropping `t_review` to 0.0 (reviewing nothing) is far more
costly (missed fraud dominates), and raising it drives cost up as more
legitimate transactions get pulled into the flat-fee review band and,
eventually, more false positives get blocked.
